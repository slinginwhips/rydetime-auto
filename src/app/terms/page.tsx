      ...
      <section className="mx-auto max-w-3xl space-y-8 px-4 py-12 text-sm leading-relaxed text-text-secondary sm:px-6 [&_h2]:text-lg [&_h2]:font-bold [&_h2]:text-text-primary">
        <div>
          ...
          <p className="mt-2">
            ...
            using this website, you agree to these Terms &amp; Conditions. If
        ...
        <div>
          ...
          <p className="mt-2">
            ...
            application does not guarantee approval. This website does not
            store the full Social Security numbers or dates of birth submitted
        ...
        <div>
          ...
          <p className="mt-2">
            If you opt in to receive text messages from RydeTime Auto — for
            example, through the SMS consent checkbox on our credit
            application — you agree to receive text messages regarding your
            vehicle inquiry, appointments, credit application, financing,
            vehicle purchase, required documents, title/registration matters,
            and related customer service communications. Message frequency
            varies. Message and data rates may apply depending on your mobile
            carrier and plan. You may opt out at any time by replying
            &quot;STOP&quot; to any message, or reply &quot;HELP&quot; for
            assistance. Consent to receive text messages is not a condition of
            purchasing any goods or services and is not required to submit a
            credit application or purchase a vehicle. See our{" "}
            <Link href="/privacy" className="text-accent hover:underline">
              Privacy Policy
            </Link>{" "}
            for how we handle your mobile information.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-2">
            ...
            information may be provided by third parties, including Carfax,
        ...
        <div>
          ...
          <p className="mt-2">
            The site links to third-party services, including Carfax (vehicle
            history), Stripe (payments), and Google Maps. We are not
